...
/**
 * Represents the forward's global state. Keeps {@link FieldPlayerGlobalState} internally and calls
 * its methods at the end of its own methods.
 */
public class ForwardGlobalState extends PlayerState {
    
    /**
     * The field player global state that is used at the end of the this state methods.
     */
    private FieldPlayerGlobalState fieldPlayerGlobalState;
    
    /**
     * Initializes a new instance of the {@link ForwardGlobalState} class.
     * @param player The player.
     * @param fsmAI The {@link FsmAI} instance to which this instance belongs.
     */
    public ForwardGlobalState(Player player, FsmAI fsmAI) {
        super(player, fsmAI);
